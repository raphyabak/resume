    ...
    <div class="orido_tm_all_wrap" data-magic-cursor="show">
        ...
        <div class="orido_tm_header">
            <div class="header_in">
                ...
                <div class="button"><a href="https://themeforest.net/user/marketify/portfolio" target="_blank">Purchase
                        Now</a></div>
            </div>
        </div>
        ...
        <div class="orido_tm_hero" id="home">
            <div class="container">
                <div class="content">
                    <div class="details">
                        <div class="short">
                            <h3>John Smith <img class="svg" src="img/svg/hi.svg" alt="" /></h3>
                            <span class="job">Visual Designer</span>
                        </div>
                        <div class="text">
                            <p>I'm creative designer based in New York, and I'm very passionate and dedicated to my
                                work.</p>
                        </div>
                        <div class="buttons">
                            <div class="orido_tm_boxed_button">
                                <a class="anchor" href="#contact">Say Hello <img class="svg" src="img/svg/send.svg"
                                        alt="" /></a>
                            </div>
                            <div class="orido_tm_simple_button">
                                <a class="line_effect anchor" href="#portfolio">My Works <img class="svg"
                                        src="img/svg/top-arrow.svg" alt="" /></a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="orido_tm_follow">
                    ...
                    <ul>
                        ...
                        <li><a href="#"><img class="svg" src="img/svg/social/dribbble.svg"
                                    alt="" /></a></li>
                        <li><a href="#"><img class="svg" src="img/svg/social/instagarm.svg"
                                    alt="" /></a></li>
                    </ul>
                </div>
            </div>
            <div class="orido_tm_down">
                <a class="anchor" href="#about"><img class="svg" src="img/svg/down_button_light.svg"
                        alt="" /></a>
            </div>
            <div class="avatar">
                <div class="img">
            ...
            <div class="orido_tm_about">
                <div class="about_in">
                    ...
                    <div class="right">
                        ...
                        <div class="text">
                            <p>With 10 years experience as a professional Web developer, I have acquired the skills and
                        ...
                        <div class="short">
                            <div class="orido_tm_boxed_button">
                                <a href="img/cv/1.jpg" download>Download CV <img class="svg"
                                        src="img/svg/paper.svg" alt="" /></a>
                            </div>
                ...
                <div class="container">
                    <div class="informations_inner">
                        <div class="left">
                            ...
                            <div class="text">
                                <p>You can express yourself however you want and whenever you want, for free. You can
                                    customize a template or make your own from scratch, with an immersive library at
                                    your disposal. You can express yourself however you want and whenever you free.</p>
                                <p>You can customize a template or make your own from scratch, with an immersive library
                                    at your disposal.</p>
                            </div>
                            <div class="orido_tm_boxed_button">
                                <a href="#">My Resume <img class="svg" src="img/svg/paper.svg"
                                        alt="" /></a>
                            </div>
                        </div>
                        <div class="right">
                            <div class="filter">
                                <ul>
                                    <li><a class="current" href="#" data-tab="tab_1"><span>Skills</span> <img
                                                class="svg" src="img/svg/top-arrow.svg" alt="" /></a></li>
                                    <li><a href="#" data-tab="tab_2"><span>Experience</span> <img
                                                class="svg" src="img/svg/top-arrow.svg" alt="" /></a></li>
                                    <li><a href="#" data-tab="tab_3"><span>Education</span> <img class="svg"
                                                src="img/svg/top-arrow.svg" alt="" /></a></li>
                                </ul>
                                <span class="ccc"></span>
                            </div>
                            <div class="content">
                                        ...
                                        <ul>
                                            <li>
                                                <div class="list_inner">
                                                    <span class="icon"><span class="in"><img class="svg"
                                                                src="img/svg/figma.svg"
                                                                alt="" /></span></span>
                                                    <p class="name">Figma <span>(90%)</span></p>
                                                </div>
                                            </li>
                                            <li>
                                                <div class="list_inner">
                                                    <span class="icon"><span class="in"><img class="svg"
                                                                src="img/svg/Ae.svg" alt="" /></span></span>
                                                    <p class="name">After Effect <span>(80%)</span></p>
                                                </div>
                                            </li>
                                            <li>
                                                <div class="list_inner">
                                                    <span class="icon"><span class="in"><img class="svg"
                                                                ...
                                                                alt="" /></span></span>
                                                    <p class="name">Photoshop <span>(85%)</span></p>
                                                </div>
                                            </li>
                                            <li>
                                                <div class="list_inner">
                                                    <span class="icon"><span class="in"><img class="svg"
                                                                src="img/svg/Xd.svg" alt="" /></span></span>
                                                    <p class="name">XD <span>(95%)</span></p>
                                                </div>
                                            </li>
                                            <li>
                                                <div class="list_inner">
                                                    <span class="icon"><span class="in"><img class="svg"
                                                                src="img/svg/illustrator.svg"
                                                                alt="" /></span></span>
                                                    <p class="name">Illustrator <span>(90%)</span></p>
                                                </div>
                                            </li>
                                            <li>
                                                <div class="list_inner">
                                                    <span class="icon"><span class="in"><img class="svg"
                                                                src="img/svg/Id.svg" alt="" /></span></span>
                                                    <p class="name">Indesign <span>(75%)</span></p>
                                                </div>
                                            </li>
                                        </ul>
                                    </div>
                                        ...
                                        <ul>
                                            <li>
                                                <div class="list_inner">
                                                    <div class="time">
                                                        <span class="year">2021 - Present</span>
                                                        <span class="company">Stanford Univercity</span>
                                                    </div>
                                                    <div class="job">
                                                        <h3><span>Web Design Course</span></h3>
                                                    </div>
                                                </div>
                                            </li>
                                            <li>
                                                <div class="list_inner">
                                                    <div class="time">
                                                        <span class="year">2020 - 2021</span>
                                                        <span class="company">Art Univercity of New York</span>
                                                    </div>
                                                    <div class="job">
                                                        <h3><span>Art Director Course</span></h3>
                                                    </div>
                                                </div>
                                            </li>
                                            <li>
                                                <div class="list_inner">
                                                    <div class="time">
                                                        <span class="year">2018 - 2020</span>
                                                        <span class="company">Amazon College</span>
                                                    </div>
                                                    <div class="job">
                                                        <h3><span>IOS Development</span></h3>
                                                    </div>
                                                </div>
                                            </li>
                                            <li>
                                                <div class="list_inner">
                                                    <div class="time">
                                                        ...
                                                        <span class="company">Univercity of Texas</span>
                                                    </div>
                                                    <div class="job">
                                                        <h3><span>UX Expert</span></h3>
                                                    </div>
                                                </div>
                                            </li>
                                        </ul>
                ...
                <div class="container">
                    <div class="counter_list">
                        <ul>
                            <li>
                                <div class="list_inner">
                                    <h3><span class="counter_item" data-from="0" data-to="219"
                            ...
                            <li>
                                <div class="list_inner">
                                    <h3><span class="counter_item" data-from="0" data-to="48"
                                            data-speed="2000">0</span></h3>
                                    <span class="title">Written Book</span>
                                </div>
                            </li>
                            <li>
                                <div class="list_inner">
                                    <h3><span class="counter_item" data-from="0" data-to="527"
                                            data-speed="2000">0</span></h3>
                            ...
                            <li>
                                <div class="list_inner">
                                    <h3><span class="counter_item" data-from="0" data-to="12"
                                            data-speed="2000">0</span></h3>
                                    <span class="title">Own Projects</span>
                                </div>
                            </li>
                        </ul>
                    </div>
                        ...
                        <ul>
                            <li class="current">
                                <div class="list_inner">
                                    ...
                                    <div class="right">
                                        <div class="text">
                                            <p>You can customize a template or make your own from scratch, with an
                                                immersive library at your disposal...</p>
                                        </div>
                                        <div class="arrow">
                                            <img class="svg" src="img/svg/top-arrow.svg" alt="" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="service_hidden_details">
                                        <div class="service_popup_informations">
                                            <div class="descriptions">
                                                <p>Orido is a leading web design agency with an award-winning design
                                                ...
                                                <p>That’s why more companies are not only reevaluating their website’s
                                                    design but also partnering with Orido, the web design agency that’s
                            ...
                            <li>
                                <div class="list_inner">
                                    <div class="left">
                                        ...
                                        <h3 class="title">UI Animation</h3>
                                    </div>
                                    <div class="right">
                                        <div class="text">
                                            <p>You can customize a template or make your own from scratch, with an
                        ...
                        <ul class="owl-carousel gallery_zoom">
                            <li>
                                <div class="list_inner">
                                    ...
                                    <div class="details">
                                        ...
                                        <h3 class="title"><span>Car Export</span></h3>
                                    </div>
                                    <a class="orido_tm_full_link popup-youtube"
                            ...
                            <li>
                                <div class="list_inner">
                                    ...
                                    <div class="details">
                                        <span class="category">Vimeo</span>
                                        <h3 class="title"><span>Food delivery</span></h3>
                                    </div>
                                    <a class="orido_tm_full_link popup-vimeo" href="https://vimeo.com/337293658"></a>
                                </div>
                            </li>
                            <li>
                                <div class="list_inner">
                                    ...
                                    <div class="details">
                                        ...
                                        <h3 class="title"><span>Ecommerce Website</span></h3>
                                    </div>
                                    <a class="orido_tm_full_link soundcloude_link mfp-iframe audio"
                            ...
                            <li>
                                <div class="list_inner">
                                    ...
                                    <div class="details">
                                        ...
                                        <h3 class="title"><span>Mockup Phone</span></h3>
                                    </div>
                                    <a class="orido_tm_full_link details_link" href="#"></a>
                                                ...
                                                <ul>
                                                    <li>
                                                        <div class="list_inner">
                                                            <div class="my_image">
                                                                ...
                                                                <div class="main" data-img-url="img/service/1.jpg">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </li>
                                                    <li>
                                                        <div class="list_inner">
                                                            <div class="my_image">
                                                                <img src="img/thumbs/4-2.jpg" alt="" />
                                                                <div class="main" data-img-url="img/service/2.jpg">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </li>
                                                    <li>
                                                        <div class="list_inner">
                                                            <div class="my_image">
                                                                <img src="img/thumbs/4-2.jpg" alt="" />
                                                                <div class="main" data-img-url="img/service/3.jpg">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </li>
                            ...
                            <li>
                                <div class="list_inner">
                                    ...
                                    <div class="details">
                                        ...
                                        <h3 class="title"><span>Felix Photo</span></h3>
                                    </div>
                                    <a class="orido_tm_full_link zoom" href="img/portfolio/5.jpg"></a>
                                </div>
                            </li>
                        </ul>
            ...
            <div class="orido_tm_testimonials">
                <div class="container">
                    ...
                    <div class="testimonials_in">
                        ...
                        <div class="info">
                            <div class="text">
                                <p>“Awesome website! Easy to use and edit, it has a lot of options to design whatever
                                    you need, it is professional and fun. I was very successful creating my profile
                                    using designer which gave me unbelievable reach &amp; appreciation.”</p>
                            </div>
                            <div class="details">
                                <h3 class="name"><span>Albert Walkers</span></h3>
                                <span class="job">Vivaco Group</span>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="orido_tm_section" id="blog">
            <div class="orido_tm_news">
                <div class="container">
                    <div class="orido_tm_main_title">
                        <h3><span>From my<br />blog post</span></h3>
                    </div>
                    <div class="news_list">
                        <ul>
                            <li>
                                <div class="list_inner">
                                    <div class="left">
                                        ...
                                        <div class="title">
                                            <h3><a href="#">Diversification of digital marketing stategies</a>
                                            </h3>
                                        </div>
                                        <div class="orido_tm_simple_button">
                                            <a class="line_effect" href="#">Read More <img class="svg"
                                                    src="img/svg/top-arrow.svg" alt="" /></a>
                                        </div>
                                    </div>
                                    <div class="right">
                                    ...
                                    <span class="shape"><img class="svg" src="img/svg/Intersect.svg"
                                            alt="" /></span>
        ...
        <div class="orido_tm_section">
            <div class="orido_tm_partners">
                <div class="container">
                    <div class="partners_list">
                        <ul class="owl-carousel">
                            <li class="item"><a href="#"><img src="img/partners/light/1.png"
                                        alt="" /></a></li>
                            <li class="item"><a href="#"><img src="img/partners/light/2.png"
                                        alt="" /></a></li>
                            <li class="item"><a href="#"><img src="img/partners/light/3.png"
                                        alt="" /></a></li>
                            <li class="item"><a href="#"><img src="img/partners/light/4.png"
                                        alt="" /></a></li>
                            <li class="item"><a href="#"><img src="img/partners/light/5.png"
                                        alt="" /></a></li>
                            <li class="item"><a href="#"><img src="img/partners/light/6.png"
                                        alt="" /></a></li>
                            <li class="item"><a href="#"><img src="img/partners/light/7.png"
                                        alt="" /></a></li>
                            <li class="item"><a href="#"><img src="img/partners/light/8.png"
                                        alt="" /></a></li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="container">
                    <div class="infobox">
                        ...
                        <div class="text">
                            ...
                            <p>You can express yourself however you want and whenever you want, for free. You can
                                customize a template or make your own.</p>
                        </div>
                        <div class="orido_tm_boxed_button">
                            <a href="#">Say Hello <img class="svg" src="img/svg/send.svg"
                                    alt="" /></a>
                        </div>
                    </div>
                    <div class="connect">
                        <div class="left">
                            <ul>
                                <li>
                                    ...
                                    <p><a class="line_effect" href="#">+1 (234) 567 890</a></p>
                                </li>
                                <li>
                                    <span class="name">Email:</span>
                                    <p><a class="line_effect" href="#"><span class="__cf_email__"
                                                data-cfemail="89fafcf9f9e6fbfdc9fae4e0fde1a7eae6e4">[email&#160;protected]</span></a>
                                    </p>
                                </li>
                            </ul>
                        </div>
                        <div class="right">
                            <div class="orido_tm_follow">
                                <span>Follow me:</span>
                                <ul>
                                    <li><a href="#"><img class="svg" src="img/svg/social/be.svg"
                                                alt="" /></a></li>
                                    <li><a href="#"><img class="svg" src="img/svg/social/dribbble.svg"
                                                alt="" /></a></li>
                                    <li><a href="#"><img class="svg" src="img/svg/social/instagarm.svg"
            ...
            <div class="orido_tm_copyright">
                <div class="container">
                    <div class="copyright_inner">
                        ...
                        <div class="copy">
                            <p>&copy; 2022 by <a href="https://themeforest.net/user/marketify"
                                    target="_blank">Marketify.</a> All Rights Reserved</p>
                        </div>
                    </div>
                </div>
            </div>
