...
function orido_tm_modalbox() {
    "use strict";
    jQuery(".orido_tm_all_wrap").prepend(
        '<div class="orido_tm_modalbox"><div class="box_inner"><div class="close"><a href="#"><i class="icon-cancel"></i></a></div><div class="description_wrap"></div></div></div>'
    );
}
...
function orido_tm_modalbox_news() {
    ...
    var modalBox = jQuery(".orido_tm_modalbox");
    var button = jQuery(
        ".orido_tm_news,.orido_tm_news .title a,.orido_tm_news .orido_tm_simple_button a"
    );
    var closePopup = modalBox.find(".close");
    button.on("click", function () {
        var element = jQuery(this);
        ...
        modalBox
            ...
            .after(
                '<div class="details"><div class="metabox">' +
                    metabox +
    ...
    if (myCursor.length) {
        if ($("body")) {
            ...
            (window.onmousemove = function (s) {
                ...
                $("body").on(
                    "mouseenter",
                    "a, .orido_tm_testimonials .avatars ul li, .cursor-pointer",
                    function () {
